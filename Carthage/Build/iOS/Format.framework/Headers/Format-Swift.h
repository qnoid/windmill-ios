...
SWIFT_MODULE_NAMESPACE_PUSH("Format")

@interface CLPlacemark (SWIFT_EXTENSION(Format))
...
- (NSString * _Nonnull)format SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=9.0);
@end
